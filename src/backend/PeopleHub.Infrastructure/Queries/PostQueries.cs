...
internal sealed class PostQueries(DbClient dbClient) : IPostQueries
{
    public async Task<IReadOnlyCollection<FeedPost>> GetFriendsFeedAsync(int userId, int offset, int limit,
