...
public sealed class CounterNotificationPublisher(RabbitMqConnection connection) : IAsyncDisposable
{
    ...
    public async Task PublishAsync(long userId, CounterNotification notification, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await channel.BasicPublishAsync(
                CountersTopology.PushedExchange,
                CountersTopology.UserRoutingKey(userId),
                mandatory: false,
