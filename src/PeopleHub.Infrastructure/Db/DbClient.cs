            ...
            $$"""
                ...
                begin
                    for i in 1..1000000 loop
                        ...
                        returning id into person_id_val;
                        ...
                        -- insert into accounts (email, password, person_id)
                        -- values (email_val, 'AKqZ8b1KrUAH/UyHDedKvCRZsLeTk8qmAJuih9sxJNlMwfuLndQTH4SqnW/xExHotg==', person_id_val);
                        ...
                        --     from persons
                        --     where id != person_id_val
                        --       and not exists (
                        --           select 1 from friend_requests 
                        --           where sender_person_id = person_id_val and receiver_person_id = persons.id
                        --       )
                        --     order by random()
                        --     limit 1;
                        --     
                        ...
                        --         insert into friend_requests (sender_person_id, receiver_person_id, status)
                        --         values (person_id_val, random_receiver, request_status);
                        --     end if;
                        -- end loop;
